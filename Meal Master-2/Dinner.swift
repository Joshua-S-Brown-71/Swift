            ...
            VStack {
                ...
                List(filteredItems) { DRecipe in
                    NavigationLink(destination: {
                        switch DRecipe.name {
                        case "Grilled Salmon":
                            GrilledSalmonRecipeView()
                        case "Pasta Primavera":
                            PastaPrimaveraRecipeView()
                        case "Beef Stir-Fry":
                            BeefStirFryRecipeView()
                        case "Vegetable Curry":
                            VegetableCurryRecipeView()
                        case "Grilled Portobello Mushrooms":
                            GrilledPortobelloMushroomsRecipeView()
                        case "Lemon Herb Roasted Chicken":
                            LemonHerbRoastedChickenRecipeView()
                        case "Teriyaki Salmon":
                            TeriyakiSalmonRecipeView()
                        case "Mushroom and Spinach Stuffed Chicken":
                            MushroomSpinachStuffedChickenRecipeView()
                        case "Chickpea and Sweet Potato Curry":
                            ChickpeaSweetPotatoCurryRecipeView()
                        case "Honey Glazed BBQ Ribs":
                            HoneyGlazedBBQRibsRecipeView()
                        default:
                            EmptyView()
                        }
                    }) {
